<template>
  <section
    id="solution"
    class="scroll-mt-20 border-b border-slate-800/60 bg-slate-900/30 px-4 py-20 sm:px-6 sm:py-24 lg:px-8"
  >
...
<style scoped>
/* Optional: add a subtle glow to DAEMON */
h1 {
  text-shadow: 0 0 30px rgba(239, 68, 68, 0.3);
  background: linear-gradient(180deg, #000091 0%,#000091 20%,#fff 60%,#e1000f 80%, #e1000f 100%);
